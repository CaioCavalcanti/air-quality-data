...
# This is a copy from gs://goog-dataproc-initialization-actions-europe-west4/connectors/connectors.sh
# as it is not recommended to reference initialization actions directly from public repositories
# in production environments.
# See https://cloud.google.com/dataproc/docs/concepts/configuring-clusters/init-actions#important_considerations_and_guidelines
